// Namespace "institucional" — português (língua de origem; define o tipo de en/pl).
export const institucional = {
  sobre: {
    metadata: {
      title: "Sobre",
      description:
        "A EvDigital é uma empresa de IT. Construímos presença digital para quem ainda não a tem, e soluções à medida para quem já precisa de mais do que um site.",
    },
    eyebrow: "Quem somos",
    title: "A EvDigital é uma empresa de IT.",
    intro:
      "Construímos presença digital para quem ainda não a tem, e soluções à medida para quem já precisa de mais do que um site.",
    whyTitle: "Porque existimos",
    whyLead: "Milhões de pequenos negócios ainda não existem na internet.",
    whyP1:
      "Não é por falta de vontade. É porque a tecnologia continua a ser explicada numa língua que exclui quem mais precisa dela.",
    whyP2:
      "Criámos a EvDigital para resolver as duas pontas do mesmo problema: quem ainda não deu o primeiro passo, e quem já quer dar o próximo.",
  ...
  termos: {
    ...
    content: {
      ...
      p1: "Procuramos manter tudo correto e atualizado, mas os textos descrevem serviços de forma geral e não constituem uma proposta contratual. Qualquer trabalho é acordado por proposta escrita e específica.",
      p2: "Os dados de mercado que citamos vêm de fontes públicas identificadas e referem-se à data em que foram publicados.",
    },
    form: {
      title: "Ao usar o formulário de contacto",
      p1Before:
        "Pedimos que use um contacto verdadeiro, para lhe podermos responder. O tratamento dos dados que nos enviar está descrito na ",
    ...
    ownership: {
      title: "Propriedade",
      text: "Os textos, imagens e código deste site pertencem à EvDigital, salvo quando indicada outra origem. Pode citar-nos com atribuição; não pode copiar o site para uso comercial próprio.",
    },
    availability: {
      title: "Disponibilidade",
      text: "Fazemos o possível por manter o site acessível, mas pode estar temporariamente indisponível para manutenção ou por motivos técnicos.",
    },
    law: {
      title: "Lei aplicável",
