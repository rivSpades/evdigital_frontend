...
// folhas da direcção "A vez": glifo "!" funcional (círculo $feedback-error-fg de 16 com a
  ...
  return (
    <p id={id} role="alert" className={cn("flex gap-xs", className)}>
      <span aria-hidden className="shrink-0 pt-3xs">
        <span className="flex size-4 items-center justify-center rounded-[var(--radius-pill)] bg-feedback-error-fg font-body text-[length:var(--spacing-sm)] leading-none font-bold text-bg-base">
          !
        </span>
      </span>
