...
// escolhível do agendamento (Contacto, passo 2). Alvo de 44 de altura, $radius-md, Hora
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "rounded-[var(--radius-md)] border font-mono text-label leading-none text-text-primary transition-colors",
        escolhida
