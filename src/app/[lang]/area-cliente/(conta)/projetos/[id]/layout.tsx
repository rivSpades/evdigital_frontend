...
// o backend só é chamado uma vez por pedido. Os pedidos do projeto arrancam já aqui, em
// paralelo (a página só renderiza depois do layout e recebe a mesma promessa). O ecrã é o de (conta)/not-found.tsx.
//
...
export default async function ProjetoDetalheLayout({
  ...
  // Só arranca a leitura; o erro, se houver, é tratado na página que a espera.
  getPedidosDoProjeto(token, id).catch(() => {});
